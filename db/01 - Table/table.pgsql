...
insert into tb_system (field) values ('{"id":1,"name":"forms"}');
...
insert into tb_table (field) values ('{"id":1,"id_system":1,"name":"system","url":"-","table_name":"tb_system"}');
insert into tb_table (field) values ('{"id":2,"id_system":1,"name":"table","url":"-","table_name":"tb_table"}');
insert into tb_table (field) values ('{"id":3,"id_system":1,"name":"field","url":"-","table_name":"tb_field"}');
insert into tb_table (field) values ('{"id":4,"id_system":1,"name":"field type","url":"-","table_name":"tb_field_type"}');
insert into tb_table (field) values ('{"id":5,"id_system":1,"name":"field event","url":"-","table_name":"tb_field_event"}');
insert into tb_table (field) values ('{"id":6,"id_system":1,"name":"report action","url":"-","table_name":"tb_report_action"}');
insert into tb_table (field) values ('{"id":7,"id_system":1,"name":"form action","url":"-","table_name":"tb_form_action"}');
insert into tb_table (field) values ('{"id":8,"id_system":1,"name":"event","url":"-","table_name":"tb_event"}');
...
insert into tb_field (field) values ('{"id":6,"id_system":1,"id_table":2,"label":"System","name":"id_system","id_type":1,"size":0,"mask":"","id_mandatory":1,"id_unique":0,"id_fk":2,"domain":""}');
...
insert into tb_field (field) values ('{"id":19,"id_system":1,"id_table":3,"label":"Inner Table","name":"id_fk","id_type":1,"size":0,"mask":"","id_mandatory":0,"id_unique":0,"id_fk":4,"domain":"tb_bool"}');
