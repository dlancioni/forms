...
insert into tb_field (field) values ('{"id":29,"id_system":1,"id_table":5,"label":"Display Type","name":"id_event_type","id_type":1,"size":0,"mask":"","id_mandatory":1,"id_unique":1,"id_fk":4,"domain":"tb_event_type"}');
...
insert into tb_event (field) values ('{"id":1,"id_target":1,"id_table":1,"id_field":0,"id_event":1,"id_event_type":2,"display":"New","code":"go(document.getElementById(''id_table'').value)"}');
insert into tb_event (field) values ('{"id":2,"id_target":1,"id_table":1,"id_field":0,"id_event":1,"id_event_type":2,"display":"Edit","code":"go(document.getElementById(''id_table'').value)"}');
insert into tb_event (field) values ('{"id":3,"id_target":1,"id_table":1,"id_field":0,"id_event":1,"id_event_type":2,"display":"Copy","code":"go(document.getElementById(''id_table'').value)"}');
insert into tb_event (field) values ('{"id":4,"id_target":1,"id_table":1,"id_field":0,"id_event":1,"id_event_type":2,"display":"Delete","code":"go(document.getElementById(''id_table'').value)"}');
insert into tb_event (field) values ('{"id":5,"id_target":2,"id_table":1,"id_field":0,"id_event":1,"id_event_type":2,"display":"Save","code":"execute()"}');
insert into tb_event (field) values ('{"id":6,"id_target":2,"id_table":1,"id_field":0,"id_event":1,"id_event_type":2,"display":"Back","code":"back(document.getElementById(''id_table'').value)"}');
