...
begin
    ...
    if (tg_op = 'INSERT') then
        ...
        jsonf := json_set('{"id":1,"name":"new","id_page":1,"id_table":0,"id_field":0,"id_event":1,"id_event_type":2,"display":"New","code":"go(getPage(), getTable(), 1, getId());"}', 'id_table', tableEventId);
        id := insert('tb_event', jsons, jsonf);
        jsonf := json_set('{"id":2,"name":"edit","id_page":1,"id_table":0,"id_field":0,"id_event":1,"id_event_type":2,"display":"Edit","code":"go(getPage(), getTable(), 2, getId());"}', 'id_table', tableEventId);
        id := insert('tb_event', jsons, jsonf);
        jsonf := json_set('{"id":3,"name":"delete","id_page":1,"id_table":0,"id_field":0,"id_event":1,"id_event_type":2,"display":"Delete","code":"go(getPage(), getTable(), 3, getId());"}', 'id_table', tableEventId);
        id := insert('tb_event', jsons, jsonf);
        ...
        id := insert('tb_event', jsons, jsonf);
        jsonf := json_set('{"id":5,"name":"filter1","id_page":1,"id_table":0,"id_field":0,"id_event":1,"id_event_type":2,"display":"Filter","code":"go(getPage(), getTable(), 5, getId());"}', 'id_table', tableEventId);
        id := insert('tb_event', jsons, jsonf);
        jsonf := json_set('{"id":6,"name":"filter2","id_page":2,"id_table":0,"id_field":0,"id_event":1,"id_event_type":2,"display":"Filter","code":"go(getPage(), getTable(), 6, getId());"}', 'id_table', tableEventId);
        id := insert('tb_event', jsons, jsonf);
        jsonf := json_set('{"id":7,"name":"back","id_page":2,"id_table":0,"id_field":0,"id_event":1,"id_event_type":2,"display":"Back","code":"go(getPage(), getTable(), 7, getId());"}', 'id_table', tableEventId);
        id := insert('tb_event', jsons, jsonf);
