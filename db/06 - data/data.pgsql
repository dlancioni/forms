...
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":3,"label":"Table","name":"id_table","field_type":"integer","size":0,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":2,"domain":""}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":3,"label":"Label","name":"label","field_type":"string","size":50,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":0,"domain":""}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":3,"label":"Name","name":"name","field_type":"string","size":50,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":0,"domain":""}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":3,"label":"Type","name":"field_type","field_type":"string","size":0,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":4,"domain":"tb_field_type"}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":3,"label":"Size","name":"size","field_type":"integer","size":0,"mask":"","id_mandatory":"N","id_unique":"N","id_fk":0,"domain":""}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":3,"label":"Mask","name":"mask","field_type":"string","size":50,"mask":"","id_mandatory":"N","id_unique":"N","id_fk":0,"domain":""}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":3,"label":"Mandatory","name":"id_mandatory","field_type":"boolean","size":0,"mask":"","id_mandatory":"N","id_unique":"N","id_fk":4,"domain":"tb_bool"}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":3,"label":"Unique","name":"id_unique","field_type":"boolean","size":0,"mask":"","id_mandatory":"N","id_unique":"N","id_fk":4,"domain":"tb_bool"}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":3,"label":"Fk","name":"id_fk","field_type":"integer","size":0,"mask":"","id_mandatory":"N","id_unique":"N","id_fk":2,"domain":""}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":3,"label":"Domain","name":"domain","field_type":"string","size":50,"mask":"","id_mandatory":"N","id_unique":"N","id_fk":0,"domain":""}');
-- tb_domain
...
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":4,"label":"Key","name":"key","field_type":"string","size":50,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":0,"domain":""}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":4,"label":"Value","name":"value","field_type":"string","size":50,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":0,"domain":""}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":4,"label":"Domain","name":"domain","field_type":"string","size":50,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":0,"domain":""}');
-- tb_event
...
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":5,"label":"Name","name":"name","field_type":"string","size":50,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":0,"domain":""}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":5,"label":"Target","name":"id_target","field_type":"integer","size":0,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":4,"domain":"tb_target"}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":5,"label":"Table","name":"id_table","field_type":"integer","size":0,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":2,"domain":""}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":5,"label":"Field","name":"id_field","field_type":"integer","size":0,"mask":"","id_mandatory":"N","id_unique":"N","id_fk":3,"domain":""}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":5,"label":"Event","name":"id_event","field_type":"integer","size":0,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":4,"domain":"tb_event"}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":5,"label":"Display Type","name":"id_event_type","field_type":"integer","size":0,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":4,"domain":"tb_event_type"}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":5,"label":"Display","name":"display","field_type":"string","size":50,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":0,"domain":""}');
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":5,"label":"Code","name":"code","field_type":"string","size":500,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":0,"domain":""}');
-- tb_code
...
select insert('tb_field', '{}','{"id":0,"id_system":1,"id_table":6,"label":"Code","name":"code","field_type":"text","size":500,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":0,"domain":""}');
