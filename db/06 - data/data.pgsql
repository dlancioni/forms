...
insert into tb_field (field) values ('{"id":22,"id_system":1,"id_table":4,"label":"Key","name":"key","id_type":3,"size":50,"mask":"","id_mandatory":1,"id_unique":2,"id_fk":0,"domain":""}');
...
insert into tb_field (field) values ('{"id":30,"id_system":1,"id_table":5,"label":"Event","name":"id_event","id_type":1,"size":0,"mask":"","id_mandatory":1,"id_unique":2,"id_fk":4,"domain":"tb_event"}');
insert into tb_field (field) values ('{"id":31,"id_system":1,"id_table":5,"label":"Display Type","name":"id_event_type","id_type":1,"size":0,"mask":"","id_mandatory":1,"id_unique":2,"id_fk":4,"domain":"tb_event_type"}');
insert into tb_field (field) values ('{"id":32,"id_system":1,"id_table":5,"label":"Display","name":"display","id_type":3,"size":50,"mask":"","id_mandatory":1,"id_unique":2,"id_fk":0,"domain":""}');
insert into tb_field (field) values ('{"id":33,"id_system":1,"id_table":5,"label":"Code","name":"code","id_type":3,"size":500,"mask":"","id_mandatory":1,"id_unique":2,"id_fk":0,"domain":""}');
-- tb_code
insert into tb_field (field) values ('{"id":34,"id_system":1,"id_table":6,"label":"Id","name":"id","id_type":1,"size":0,"mask":"","id_mandatory":1,"id_unique":1,"id_fk":0,"domain":""}');
insert into tb_field (field) values ('{"id":35,"id_system":1,"id_table":6,"label":"Code","name":"code","id_type":6,"size":500,"mask":"","id_mandatory":1,"id_unique":2,"id_fk":0,"domain":""}');
...
-- tb_bool
insert into tb_domain (field) values ('{"id":1,"id_system":1,"key":1,"value":"Yes","domain":"tb_bool"}');
insert into tb_domain (field) values ('{"id":2,"id_system":1,"key":2,"value":"No","domain":"tb_bool"}');
-- tb_field_type
insert into tb_domain (field) values ('{"id":3,"id_system":1,"key":1,"value":"Integer","domain":"tb_field_type"}');
insert into tb_domain (field) values ('{"id":4,"id_system":1,"key":2,"value":"Decimal","domain":"tb_field_type"}');
insert into tb_domain (field) values ('{"id":5,"id_system":1,"key":3,"value":"String","domain":"tb_field_type"}');
insert into tb_domain (field) values ('{"id":6,"id_system":1,"key":4,"value":"Date","domain":"tb_field_type"}');
insert into tb_domain (field) values ('{"id":7,"id_system":1,"key":5,"value":"Boolean","domain":"tb_field_type"}');
insert into tb_domain (field) values ('{"id":8,"id_system":1,"key":6,"value":"Text","domain":"tb_field_type"}');
-- tb_target
