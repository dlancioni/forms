...
insert into tb_field (field) values ('{"id":19,"id_system":1,"id_table":3,"label":"Inner Table","name":"id_fk","id_type":1,"size":0,"mask":"","id_mandatory":0,"id_unique":0,"id_fk":2,"domain":""}');
