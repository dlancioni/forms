...
insert into tb_field (field) values ('{"id":14,"id_system":1,"id_table":3,"label":"Type","name":"field_type","field_type":"string","size":0,"mask":"","id_mandatory":"Y","id_unique":"N","id_fk":4,"domain":"tb_field_type"}');
